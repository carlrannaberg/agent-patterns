...
export class SequentialProcessingService {
  ...
  async generateMarketingCopy(input: string) {
    ...
    this.logger.log('Step 1: Generating initial marketing copy');
    ...
    this.logger.log('Step 2: Evaluating copy quality metrics');
    ...
    this.logger.log('Step 4: Streaming final result');
    ...
    this.logger.log('Sequential processing completed, returning stream');
    return result;
  }
}
